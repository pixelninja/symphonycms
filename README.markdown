...
<<<<<<< HEAD
Symphony is a `PHP` & `MySQL` based CMS that utilises `XML` and `XSLT` as its core technologies. This repository represents version `2.5.3` and is considered stable.
=======
...
>>>>>>> 5a1cbc5... Bump version to 2.6.0-alpha.1
